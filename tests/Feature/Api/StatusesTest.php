...
class StatusesTest extends TestCase
{
    ...
    public function testValidatedValuesEdit()
    {

        $this->statusErrorData['accepted'] = "dfsafa";

        $response = $this->put(route('status.update', ['status' => 1]), $this->statusErrorData);
    ...
    public function testAcceptedStatus()
    {
        ...
        $response = $this->put(route('status.update', ['status' => 2]), $data);
    ...
    public function testAcceptedStatusAnyAccepted()
    {
        Status::factory()->create([
           'id' => 2,
           'accepted' => false
