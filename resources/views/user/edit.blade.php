                ...
                <div class="row p-5 g-3 m-0">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="text" class="form-control" id="validationCustomUsername @error('email_company') is-invalid @enderror " aria-describedby="inputGroupPrepend" name="email_company" value="{{ old('email_company', $user->email_company ?? "") }}" placeholder="@lang('profil.email_company')" required>
                            @error('email_company')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group has-validation">
                            <span class="input-group-text" id="inputGroupPrepend">@</span>
                            <input type="text" class="form-control" id="validationCustomUsername @error('email_private') is-invalid @enderror " aria-describedby="inputGroupPrepend" name="email_private" value="{{ old('email_private', $user->email_private ?? "") }}" placeholder="@lang('profil.email_private')" required>
                            @error('email_private')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" id="validationCustomUsername @error('email') is-invalid @enderror " aria-describedby="inputGroupPrepend" name="number_phone" value="{{ old('number_phone', $user->number_phone ?? "") }}" placeholder="@lang('profil.number_phone')" required>
                            @error('number_phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" id="validationCustomUsername @error('city') is-invalid @enderror " aria-describedby="inputGroupPrepend" name="city" value="{{ old('city', $user->city ?? "") }}" placeholder="@lang('profil.city')" required>
                            @error('city')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" id="validationCustomUsername @error('zip_code') is-invalid @enderror " aria-describedby="inputGroupPrepend" name="zip_code" value="{{ old('zip_code', $user->zip_code ?? "") }}" placeholder="@lang('profil.zip_code')" required>
                            @error('zip_code')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group has-validation">
                            <input type="text" class="form-control" id="validationCustomUsername @error('street') is-invalid @enderror " aria-describedby="inputGroupPrepend" name="street" value="{{ old('street', $user->street ?? "") }}" placeholder="@lang('profil.street')" required>
                            @error('street')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
